...
ActiveRecord::Schema.define(:version => 20130501170358) do
  ...
  create_table "bumps", :force => true do |t|
    ...
    t.datetime "created_at",                                                    :null => false
    t.datetime "updated_at",                                                    :null => false
    t.datetime "unbumped_at"
    t.decimal  "invested_cred", :precision => 15, :scale => 2, :default => 0.0
    t.decimal  "cred_value",    :precision => 15, :scale => 2, :default => 0.0
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.datetime "updated_at",                                                               :null => false
    t.string   "username"
    t.decimal  "available_cred",         :precision => 15, :scale => 2, :default => 100.0
  end
